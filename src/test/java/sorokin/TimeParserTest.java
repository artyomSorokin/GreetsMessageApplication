...
public class TimeParserTest {
    ...
    public void defineTimeLimitMorningTest(){
        ...
        Assert.assertEquals(timeParser.message, "Good morning, World!");
    }
    ...
    public void defineTimeLimitDayTest(){
        ...
        timeParser.defineTime();
        Assert.assertEquals(timeParser.message, "Good day, World!");
    }
    ...
    public void defineTimeLimitEveningTest(){
        ...
        timeParser.defineTime();
        Assert.assertEquals(timeParser.message, "Good evening, World!");
    }
    ...
    public void defineTimeLimitNightTest(){
        ...
        timeParser.defineTime();
        Assert.assertEquals(timeParser.message, "Good night, World!");
    }
